...
import { StoreManager } from '../../../main/StoreManager'; // Ensure StoreManager is in the correct path
...
export default function NewTask() {
    ...
    const handleSave = (e) => {
        ...
        // Save the new task to the store
        store.addItem(newTask); // Add the new task to the store
        navigate('/', { state: { newTask } }); // Navigate and pass the new task
    };
